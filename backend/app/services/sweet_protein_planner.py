...
SCAFFOLDS = [
    ...
    {
        "id": "ph_responsive",
        "name": "Miraculin / neoculin / curculin",
        "priority": 4,
        "route": "ph_responsive_research",
        "strengths": ["acid-triggered product concepts"],
        "risks": ["multimer/glycosylation complexity", "regulatory immaturity"],
        "design_focus": ["pH response", "acid beverage specialization"],
    },
    {
