...
def _import_experiment_results(connection, project_id: str, filename: str, raw: bytes) -> dict:
    ...
    return {"imported": imported, "batch_id": batch_id, "project_id": project_id}
...
async def upload_experiment_results(
    ...
    result = await run_in_threadpool(_import_experiment_results, connection, project_id, filename, raw)
