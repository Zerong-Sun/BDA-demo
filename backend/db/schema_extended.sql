...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  input_manifest_artifact_id TEXT REFERENCES artifacts(artifact_id) ON DELETE SET NULL,
  output_manifest_artifact_id TEXT REFERENCES artifacts(artifact_id) ON DELETE SET NULL,
  logs TEXT,
  error_message TEXT,
  external_id TEXT,
