...
DELETE FROM literature_subscriptions;
...
DELETE FROM scientific_claims;
DELETE FROM document_chunks;
DELETE FROM literature_documents;
DELETE FROM script_parameter_observations;
DELETE FROM script_assets;
DELETE FROM research_sources;
DELETE FROM model_parameter_catalog;
